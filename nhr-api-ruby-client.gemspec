...
# -*- encoding: utf-8 -*-
# stub: nhr-api-ruby-client 0.6.0 ruby lib

Gem::Specification.new do |s|
  s.name = "nhr-api-ruby-client".freeze
  s.version = "0.6.0"
  ...
  s.date = "2017-02-08"
  s.description = "The ruby gem about NHR Device".freeze
  ...
  s.homepage = "http://github.com/kaogaau/nhr-api-ruby-client".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.8".freeze
  s.summary = "The ruby gem about NHR Device".freeze
